...
static constexpr std::pair<SyntaxKind, std::string_view> KIND_NAMES[] = {
    ...
    {SyntaxKind::InterfaceDecl,     "InterfaceDecl"},
    {SyntaxKind::PrimitiveDecl,     "PrimitiveDecl"},
    {SyntaxKind::ImplementsClause,  "ImplementsClause"},
    ...
    {SyntaxKind::GenericNameExpr,   "GenericNameExpr"},
    ...
    {SyntaxKind::NamedArgument,     "NamedArgument"},
    ...
    {SyntaxKind::CheckedCastExpr,   "CheckedCastExpr"},
    {SyntaxKind::TypeTestExpr,      "TypeTestExpr"},
...
static constexpr std::pair<std::u16string_view, SyntaxKind> KEYWORD_TABLE[] = {
    ...
    {u"interface", SyntaxKind::KwInterface},
    {u"is",        SyntaxKind::KwIs},
    {u"lazy",      SyntaxKind::KwLazy},
    {u"let",       SyntaxKind::KwLet},
    {u"new",       SyntaxKind::KwNew},
    {u"noreturn",  SyntaxKind::KwNoreturn},
